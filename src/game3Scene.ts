...
export default class Game3Scene extends Phaser.Scene {
    ...
    create() {
        ...
        this.makeImageBtn(startX + spacing * 4, yPos - 30, "dog", () =>
         ...
         this.add.text(startX + spacing * 2, yPos + 25, "Apple Tree(T)", { fontSize: "17px", fontStyle: "bold", color: "#000" }).setOrigin(0.5);
    ...
    private showAnswer(text: string): void {
        ...
        this.currentAnswerText = this.add.text(W / 2, H / 2, text, {
            ...
            color: "#000000",
            fontStyle: "bold",
            backgroundColor: "rgba(238, 238, 238, 0.6)",  // Added white/light gray background
